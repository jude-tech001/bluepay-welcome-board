          ...
          <div className="bg-white rounded-xl p-4 mb-6 space-y-4">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-lg font-semibold">6,500</p>
              </div>
              <button onClick={() => copyToClipboard('6,500')} className="p-2 bg-blue-400 rounded-lg">
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-lg font-semibold">1014115352</p>
              </div>
              <button onClick={() => copyToClipboard('1014115352')} className="p-2 bg-blue-400 rounded-lg">
                <Copy size={16} className="text-white" />
              </button>
            </div>
            ...
            <div>
              ...
              <p className="text-lg font-semibold">Guarantee trust bank</p>
            </div>
